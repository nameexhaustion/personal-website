...
author: Simon Lin
description: Hiding your real email address behind aliases helps keep it safe from spam
...
- Outlook: [Add or remove an email alias in Outlook.com](https://support.microsoft.com/en-us/office/add-or-remove-an-email-alias-in-outlook-com-459b1989-356d-40fa-a689-8f285b13f1f2)
- ProtonMail: [Creating email aliases](https://protonmail.com/blog/what-is-email-alias/#creating-email-aliases)

You can use Google to see if your email provider has aliasing support.

# Creating email aliases with SimpleLogin

[SimpleLogin](https://simplelogin.io/) is a free email aliasing service you
can use with any email account. You can get started by signing up with your
email.
